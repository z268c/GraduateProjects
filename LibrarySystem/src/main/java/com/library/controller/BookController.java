...
import com.library.bean.NoticeTime;
...
public class BookController {
     ...
     * 增加
     */
   /* @RequestMapping("/admin_notice.html")
    public ModelAndView adminNotice() {
    	ArrayList<Notice> notice= noticeService.getAllNotice();
    	ModelAndView modelAndView=new ModelAndView("admin_notice");
    ...
    public ModelAndView noticeList(HttpServletRequest request) {
        ModelAndView modelAndView = new ModelAndView("admin_notice");
        ArrayList<Notice> notices = noticeService.noticeList();
        //ArrayList<LendDate> lendDates = new ArrayList<>();
        ArrayList<NoticeTime> noticeTime=new ArrayList<>();
        for (Notice notice: notices) {
            //LendDate lendDate = new LendDate();
            NoticeTime ntime=new NoticeTime();
            BeanUtils.copyProperties(notice,ntime);
            if (notice.getPublish_time()!=null)
            ntime.setPublishtimeStr(new SimpleDateFormat("yyyy-MM-dd").format(notice.getPublish_time()));
            
        }
        modelAndView.addObject("list",noticeTime);
        return modelAndView;
    }
