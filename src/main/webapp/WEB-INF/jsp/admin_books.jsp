...
<div class="panel panel-default" style="width: 80%;margin-left: 10%">
    ...
    <div class="panel-body">
        <table class="table table-hover">
            <thead style="font-size: 12px;background-color: lightgray;">
            <tr>
                <th>书名</th>
                <th>作者</th>
                <th>出版社</th>
            ...
            <tr>
                ...
                <td><a href="admin_book_detail.html?bookId=<c:out value="${book.bookId}"></c:out>">
                    <button type="button" class="btn btn-primary btn-xs">详 情</button>
                </a></td>
                <!-- <span class="glyphicon glyphicon-edit"></span> -->
                <td><a href="updatebook.html?bookId=<c:out value="${book.bookId}"></c:out>"><button type="button" class="btn btn-info btn-xs">编 辑</button></a></td>
                <td><a href="deletebook.html?bookId=<c:out value="${book.bookId}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删 除</button></a></td>
            </tr>
            </c:forEach>
            </tbody>
        </table>
