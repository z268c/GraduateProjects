...
<div class="col-md-6 col-md-offset-3" style="padding-top: 100px;position: relative">
<div class="panel panel-primary">
    ...
    <form action="book_add_do.html" method="post" id="addbook">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="请输入图书书名">
        </div>
        <div class="form-group">
        ...
        <input type="submit" value="添 加" class="btn btn-success btn-sm" class="text-left">
        <script>
